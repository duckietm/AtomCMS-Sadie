<x-app-layout>
    ...
    <div class="col-span-12">
        <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
            ...
            <x-leaderboard-card title="{{ __('Hours online') }}" icon="clock.gif" :data="$mostOnline" relationship="player" valueKey="gotw_points" valueType="Hours online" :formatValue="fn($value) => round($value / 3600)" />
